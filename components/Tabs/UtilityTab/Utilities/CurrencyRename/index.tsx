...
import { EXCHANGES, IPartialSavedData, ISavedData, ITrade } from '../../../../../src/types';
            ...
            <div className='DailyBalance'>
                <div className='center tc mt2'>
                    ...
                    <select name='type' id='type' onChange={this.onSelectChange('currency')}>
                        {getCurrenciesByExchange(this.props.savedData.trades, this.state.exchange).map(
                            (currency: string) =>
                                <option key={currency} value={currency} selected={currency === this.state.currency}>
                                    {currency}
                                </option>,
                        )}
                    </select>
